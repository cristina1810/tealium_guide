export default function VideoButton() {
  return (
    <button class="relative flex items-center px-5 py-1.5 overflow-hidden font-medium transition-all bg-indigo-500 rounded-md group">
      ...
      <span class="relative w-full text-sm text-left text-white transition-colors duration-200 ease-in-out group-hover:text-white">
        Ver vídeo
      </span>
    </button>
  );
