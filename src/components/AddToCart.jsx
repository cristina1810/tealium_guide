...
export default function AddToCart() {
  ...
  const addVariable = () => {
    setVariables([
      ...variables,
      { id: nextId, set: "", to: "Data Layer Value", value: "" },
    ]);
    setNextId(nextId + 1);
  };
      ...
      <div className="w-full bg-white  rounded-lg">
        ...
        <div className="px-6 py-5 border-b border-gray-200">
          ...
          <p className="text-xs text-gray-400 mb-4">
            Target a specific element by entering its ID, class, or another
            valid selector.
          </p>
              ...
              >
                ...
                <div className="relative flex-1 min-w-0">
                  <select
                    value={v.set}
                    onChange={(e) =>
                      updateVariable(v.id, "set", e.target.value)
                    }
                ...
                <div className="flex items-center gap-1 shrink-0">
                  <button className="w-5 h-5 flex items-center justify-center text-blue-500 hover:text-blue-700 text-lg leading-none">
                    <Plus size={14} />
                  </button>
                  <button className="w-5 h-5 flex items-center justify-center text-blue-500 hover:text-red-500 text-lg leading-none">
                    <Minus size={14} />
                  </button>
                </div>
              </div>
