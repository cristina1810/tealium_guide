    ...
    >
      ...
      <header className="mb-16">
        ...
        >
          ...
          técnica desglosa la anatomía de Tealium iQ para asegurar una
          implementación precisa y eficiente.
        </p>
      </header>
      ...
      <section className="grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8 mb-20">
        ...
        >
          <div>
            ...
            <p
              ...
              style={{ color: colors.onSurfaceVariant }}
            >
              El centro neurálgico donde visualiza el estado global de su
              perfil. Desde aquí puede acceder a versiones guardadas, historial
              de publicaciones y métricas de salud de las etiquetas en tiempo
              real.
            </p>
        ...
        >
          ...
          <p
            ...
            style={{ color: colors.onSurfaceVariant }}
          >
            Contenedores de código de terceros. Tealium ofrece una biblioteca de
            más de 1000 integraciones llave en mano.
          </p>
        ...
        >
          ...
          <p
            ...
            style={{ color: colors.onSurfaceVariant }}
          >
            La lógica condicional que determina cuándo y dónde se activan las
            etiquetas basándose en datos del Data Layer.
          </p>
          <div
        ...
        >
          <div className="flex-1">
            ...
            <p
              ...
              style={{ color: colors.onSurfaceVariant }}
            >
              Transforme, limpie y manipule sus datos sin necesidad de escribir
              JavaScript complejo. Las extensiones permiten modificar valores
              del Data Layer antes de que se envíen a las etiquetas.
            </p>
          </div>
        ...
        >
          ...
          <div className="md:w-1/3">
            ...
            <div className="space-y-4">
              <DataLayerStep
                num="01"
                text="Variables de UDO (Universal Data Object)"
              />
              <DataLayerStep
                num="02"
                text="Variables de Query String y Cookies"
              />
          ...
          >
            ...
            <p
              ...
              style={{ color: colors.onSurfaceVariant }}
            >
              El Data Layer es el primer paso en la ejecución de Tealium. Casi
              todas las preguntas del examen técnico giran en torno a cómo el
              Data Layer alimenta a las Load Rules y Tags. Recuerde la
              jerarquía: El UDO siempre es prioritario sobre las variables
              capturadas del DOM.
            </p>
            <button
              type="button"
